...
public final class AnalyticsRateLimitSubjectHasher {
    private static final String HMAC_ALGORITHM = "HmacSHA256";
    private static final String NAMESPACE = "public-events-v1";
    ...
    public AnalyticsRateLimitSubjectHasher() {
        this(randomKey());
    }

    AnalyticsRateLimitSubjectHasher(byte[] key) {
    ...
    public String hash(String canonicalAddress) {
        if (canonicalAddress == null
            ...
            throw new IllegalStateException("analytics rate-limit subject hashing failed");
        }
    ...
    public String toString() {
        return "AnalyticsRateLimitSubjectHasher[key=<redacted>]";
    }
